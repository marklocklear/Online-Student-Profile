...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Result'
        db.create_table('surveys_result', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date_taken', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('surveys', ['Result'])

        # Adding model 'Answer'
        db.create_table('surveys_answer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surveys.Result'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('surveys_result')
    ...
    models = {
        ...
        'surveys.answer': {
            ...
            'result': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['surveys.Result']"})
        },
        'surveys.result': {
